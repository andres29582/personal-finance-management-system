...
Verificacao focalizada de metas e alertas nesta etapa:

- `backendnest`: `npx jest --config ./test/jest-e2e.json --runInBand test/metas-alertas-integrity.e2e-spec.ts` -> 1 suite / 1 teste passando.
